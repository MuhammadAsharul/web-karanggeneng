    ...
    <div class="sidebar-wrapper active">
        ...
        <div class="sidebar-menu">
            <ul class="menu">
                ...
                <li class="sidebar-item has-sub {{ request()->routeIs('category.index') ? 'active' : '' }}">
                ...
                <li class="sidebar-item has-sub {{ request()->routeIs('tag.index') ? 'active' : '' }}">
                    ...
                    <ul class="submenu">
                        <li class="submenu-item {{ request()->routeIs('tag.index') ? 'active' : '' }}">
                            <a href="{{ route('tag.index') }}">Daftar Tag</a>
                        </li>
                    </ul>
                </li>
                <li class="sidebar-item has-sub {{ request()->routeIs('post.index') ? 'active' : '' }}">
                    <a href="{{ route('post.index') }}" class="sidebar-link">
                        <i class="bi bi-file-earmark-medical-fill"></i>
                        <span>Post</span>
                    </a>
                    <ul class="submenu">
                        <li class="submenu-item {{ request()->routeIs('post.index') ? 'active' : '' }}">
                            <a href="{{ route('post.index') }}">Daftar Post</a>
                        </li>
                    </ul>
                </li>
